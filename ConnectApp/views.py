...
def login_view(request):
    if request.method == "POST":
        ...
        if user is not None:
            login(request, user)
            return HttpResponseRedirect(reverse("ConnectApp:index"))
        else:
            return render(request, "ConnectApp/login.html", {
...
def signup_view(request):
    if request.method == "POST":
        ...
        if password != confirmation:
            return render(request, "ConnectApp/signup.html", {
...
def profile(request, username):
    ...
    return render(request, 'ConnectApp/profile.html', {
        "username": user,
        "posts": posts,
...
def following(request):
    if request.user.is_authenticated:
        ...
        return HttpResponseRedirect(reverse('ConnectApp:login'))
...
def about_us(request):
    return render(request, 'ConnectApp/about.html')

def edit_profile(request):
    return render(request, 'ConnectApp/edit.html')
